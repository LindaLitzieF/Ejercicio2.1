...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btngrabar =(Button)findViewById(R.id.am_btngrabar);
        btnsalvar =(Button)findViewById(R.id.am_btnsalvar);
    ...
    {
        Intent playIntent =new Intent(this,ActivityVideo.class);
